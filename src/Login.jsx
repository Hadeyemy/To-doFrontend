...
export default function Login({ setToken }) {
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-8 bg-white bg-opacity-30 rounded-lg shadow-xl border border-white border-opacity-40 backdrop-blur-sm shadow-blue-300/50">
      ...
      >
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded w-full transition-color duration-200 shadow-blue-300/50"
        >
